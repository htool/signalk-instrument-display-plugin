...
- CSS brightness filter: read `electrical.displays.brightness` (0–1). Fall back to deprecated `environment.displayMode.backlight` (1–10) until that blob is unused.
